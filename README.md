...
Laboratory test results experienced delayed turnaround time from January to July 2026, with an average monthly delay rate of **19%**, consistently exceeding the laboratory target of <10% per month.
...
<p align="center">
  <img src="images/laboratory_tat_dashboard.png" width="900">
</p>
...
<p align="center">
  <img src="images/monthly_tat_delay_rate.png" width="600">
</p>

- Tests with **repeat testing** had a much higher delay rate (**55.11%**) than tests without repeat testing (**15.08%**).

<p align="center">
  <img src="images/tat_delay_rate_by_repeat_testing.png" width="400">
</p>
...
<p align="center">
  <img src="images/tat_delay_rate_by_equipment_status.png" width="400">
</p>
...
<p align="center">
  <img src="images/average_staff_on_duty.png" width="550">
</p>
...
<p align="center">
  <img src="images/monthly_staff_survey_factors.png" width="500">
</p>

## Recommendations

- Meet the required staffing level on at least **90% of shifts**.

- Investigate the main causes of repeat testing and reduce repeat-testing delays from **55.11% to below 20% within six months**.

- Reduce equipment-related delays from **39% to below 20% within six months** through preventive maintainance.
